...
internal class SykepengegrunnlagsfaktaArbeidsgiverEqualsTest {
    ...
    fun `referential equals`() {
        ...
        val arbeidsgiverEtterHovedregel = Arbeidsgiver.EtterHovedregel("organisasjonsnummer", 500000.0)
    ...
    fun `structural equals`() {
        val arbeidsgiverEtterSkjønn1 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 500000.0, 600000.0)
        val arbeidsgiverEtterSkjønn2 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 500000.0, 600000.0)
        val arbeidsgiverEtterHovedregel1 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer", 500000.0)
        val arbeidsgiverEtterHovedregel2 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer", 500000.0)
    ...
    fun `not equals - EtterSkjønn - organisasjonsnummer`() {
        val arbeidsgiver1 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer1", 500000.0, 600000.0)
        val arbeidsgiver2 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer2", 500000.0, 600000.0)
    ...
    fun `not equals - EtterHovedregel - organisasjonsnummer`() {
        val arbeidsgiver1 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer1", 500000.0)
        val arbeidsgiver2 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer2", 500000.0)
        assertNotEquals(arbeidsgiver1, arbeidsgiver2)
        assertNotEquals(arbeidsgiver1.hashCode(), arbeidsgiver2.hashCode())
    }
    ...
    fun `not equals - EtterSkjønn - omregnetÅrsinntekt`() {
        val arbeidsgiver1 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 500000.0, 600000.0)
        val arbeidsgiver2 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 400000.0, 600000.0)
        assertNotEquals(arbeidsgiver1, arbeidsgiver2)
        assertNotEquals(arbeidsgiver1.hashCode(), arbeidsgiver2.hashCode())
    }
    ...
    fun `not equals - EtterHovedregel - omregnetÅrsinntekt`() {
        val arbeidsgiver1 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer", 500000.0)
        val arbeidsgiver2 = Arbeidsgiver.EtterHovedregel("organisasjonsnummer", 400000.0)
        assertNotEquals(arbeidsgiver1, arbeidsgiver2)
        assertNotEquals(arbeidsgiver1.hashCode(), arbeidsgiver2.hashCode())
    }
    ...
    fun `not equals - EtterSkjønn - skjønnsfastsatt`() {
        val arbeidsgiver1 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 500000.0, 600000.0)
        val arbeidsgiver2 = Arbeidsgiver.EtterSkjønn("organisasjonsnummer", 500000.0, 700000.0)
        assertNotEquals(arbeidsgiver1, arbeidsgiver2)
        assertNotEquals(arbeidsgiver1.hashCode(), arbeidsgiver2.hashCode())
    }
}