...
internal class TrengerTotrinnsvurderingCommand(
    ...
    internal fun getWarningtekst(overstyringer: List<OverstyringType>): String {
    ...
    private fun varselkoder(overstyringer: List<OverstyringType>): List<Varselkode> {
