...
internal class VedtaksperiodeReberegnetPeriodehistorikk(
    ...
    override fun execute(context: CommandContext): Boolean {
        ...
        if(utbetalingId != null) {
            sikkerLogg.info("Vedtaksperiode reberegnet lagres som periodehistorikk på vedtaksperiode {} med utbetalingId {}", vedtaksperiodeId, utbetalingId)
            periodehistorikkDao.lagre(PeriodehistorikkType.VEDTAKSPERIODE_REBEREGNET, null, utbetalingId)
        } else {
            sikkerLogg.info("Kunne ikke legge til periodehistorikk ved reberegnet vedtaksperiode. Finner ikke utbetalingId for vedtaksperiodeId {} ", vedtaksperiodeId)
        }
