...
internal class AutomatiseringMedResetCommand(
    ...
    private companion object {
        private val logg = LoggerFactory.getLogger(AutomatiseringMedResetCommand::class.java)
    }

    override fun execute(context: CommandContext): Boolean {
        automatisering.reset(vedtaksperiodeId, hendelseId)
