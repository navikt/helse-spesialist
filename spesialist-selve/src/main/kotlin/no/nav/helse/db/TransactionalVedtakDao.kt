...
class TransactionalVedtakDao(private val transactionalSession: TransactionalSession) : VedtakRepository {
    ...
    override fun opprettKobling(
        ...
        val statement =
            ...
            """.trimIndent()
        transactionalSession.run(queryOf(statement, vedtaksperiodeId, hendelseId).asUpdate)
    }
    ...
    override fun fjernKobling(
        ...
        transactionalSession.run(queryOf(statement, hendelseId, vedtaksperiodeId).asUpdate)
    }
