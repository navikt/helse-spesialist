...
internal fun Route.overstyringApi(hendelseMediator: HendelseMediator) {
    ...
    post("/api/overstyr/inntekt") {
        ...
        val harOverstyringAvRefusjonTilgang = listOf("G103083", "N115007", "C117102", "J153777", "F131883", "K104953", "S109031", "V149621", "S160466", "O123659", "B164848", "K162139").contains(saksbehandler.toDto().ident)
