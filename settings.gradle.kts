...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            version("rapids-and-rivers", "2025012712551737978926.de930d8e0feb")
            ...
            library("graphql-kotlin-ktor-server", "com.expediagroup", "graphql-kotlin-ktor-server").versionRef("graphql-kotlin")
