...
class PgPeriodehistorikkApiDao internal constructor(
    ...
    override fun finn(
        ...
        innslag_via_behandling_med_behandlingId AS
        (
            SELECT ph.id
            FROM periodehistorikk ph
            JOIN behandling b ON behandling_id = unik_id
            WHERE b.spleis_behandling_id = :behandling_id
        )
        ...
        (
            ...
            UNION ALL
            SELECT id FROM innslag_via_behandling_med_behandlingId
        )
        """.trimIndent(),
        "utbetaling_id" to utbetalingId,
        "behandling_id" to spleisBehandlingId,
