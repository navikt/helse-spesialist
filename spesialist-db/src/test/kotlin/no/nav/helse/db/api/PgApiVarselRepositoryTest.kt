...
internal class PgApiVarselRepositoryTest: DatabaseIntegrationTest() {
    ...
    fun `Uberegnet periode skal vise varsler fordi den er tilstøtende de to andre periodene`() {
        ...
        val periodeMedOppgave = periode("2023-01-05","2023-01-06")
        opprettVedtaksperiode(personRef, arbeidsgiverRef, periode = periodeMedOppgave, skjæringstidspunkt = 1.januar)
    ...
    fun `Bare den tilstøtende uberegnede perioden skal vise varsler`() {
        ...
        val periodeMedOppgave = periode("2023-01-06","2023-01-07")
        opprettVedtaksperiode(personRef, arbeidsgiverRef, periode = periodeMedOppgave, skjæringstidspunkt = 4.januar)
        opprettVedtak(personRef, arbeidsgiverRef, periode = uberegnetPeriode1, skjæringstidspunkt = 1.januar)
