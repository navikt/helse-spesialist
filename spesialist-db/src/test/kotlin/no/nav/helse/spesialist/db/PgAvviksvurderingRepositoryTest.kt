...
internal class PgAvviksvurderingRepositoryTest : DatabaseIntegrationTest() {
    private val avviksvurderingDao = DBSessionContext(session, TilgangskontrollForTestHarIkkeTilgang).avviksvurderingRepository
