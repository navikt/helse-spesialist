...
class PgMeldingDaoTest {
    ...
    fun `finn siste behandling opprettet om det er korrigert søknad`() {
        ...
        val behandlingOpprettetRevurdering =
            lagBehandlingOpprettet(
                fødselsnummer = fødselsnummer,
                vedtaksperiodeId = vedtaksperiodeId1,
                type = "Revurdering",
            )
        val behandlingOpprettetSøknad =
            lagBehandlingOpprettet(
                fødselsnummer = fødselsnummer,
                ...
                mapOf(
                    ...
                    "Godkjenning" to
                        mapOf(
                            ...
                            "relevanteSøknader" to listOf(UUID.randomUUID()),
                            "arbeidssituasjon" to null,
                        ),
                ).toJson(),
        )
    }
    ...
    private fun Map<String, Any>.toJsonNode(): JsonNode = objectMapper.readTree(this.toJson())
}
