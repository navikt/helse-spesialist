...
internal enum class Inntektstype {
    EnArbeidsgiver,
}
...
internal enum class Sykdomsdagtype {
    Arbeidsdag,
    Arbeidsgiverdag,
    MeldingTilNavDag,
...
internal enum class UtbetalingsdagType {
...
internal enum class Sykdomsdagkildetype {
    Inntektsmelding,
    Soknad,
    Sykmelding,
    Saksbehandler,
...
internal enum class Begrunnelse {
...
internal enum class Periodetilstand {
    TilUtbetaling,
    TilAnnullering,
    AvventerAnnullering,
    Utbetalt,
...
internal enum class Utbetalingstatus {
    Annullert,
...
internal enum class Utbetalingtype {
    UTBETALING,
    ETTERUTBETALING,
    ANNULLERING,
    REVURDERING,
...
internal data class Sykdomsdagkilde(
    val id: UUID,
...
internal sealed interface Tidslinjeperiode {
...
internal data class UberegnetPeriode(
    ...
    override val inntektstype: Inntektstype = Inntektstype.EnArbeidsgiver,
) : Tidslinjeperiode
...
internal data class Periodevilkar(
...
internal data class PensjonsgivendeInntekt(
    val inntektsar: Int,
    val arligBelop: Double,
)

internal data class Annulleringskandidat(
    val vedtaksperiodeId: UUID,
