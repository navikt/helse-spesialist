...
@Generated
public data class GraphQLOppdrag(
    @get:JsonProperty(value = "fagsystemId")
    public val fagsystemId: String,
    ...
    @get:JsonProperty(value = "utbetalingslinjer")
    public val utbetalingslinjer: List<GraphQLUtbetalingslinje>,
    @get:JsonProperty(value = "simulering")
    public val simulering: GraphQLSimulering?,
)
