    ...
    override fun settAutomatiseringInaktiv(
        ...
        asSQL(
            ...
            WHERE vedtaksperiode_ref = (
                SELECT id FROM vedtaksperiode WHERE vedtaksperiode.vedtaksperiode_id = :vedtaksperiodeId LIMIT 1
            )
    ...
    override fun hentAktivAutomatisering(
        ...
        return asSQL(
            ...
            FROM automatisering a
                JOIN vedtaksperiode v ON a.vedtaksperiode_ref = v.id
    ...
    private fun lagre(
        ...
        problems.forEach { problem ->
            asSQL(
                ...
                VALUES ((SELECT id FROM vedtaksperiode WHERE vedtaksperiode_id = :vedtaksperiodeId), :hendelseId, :problem)
                """.trimIndent(),
                "vedtaksperiodeId" to vedtaksperiodeId,
                "hendelseId" to hendelseId,
                "problem" to problem,
