...
class DeletePåVentBehandlerTest {
    ...
    private val påVentRepository = integrationTestFixture.sessionContext.påVentRepository
    private val dialogRepository = integrationTestFixture.sessionContext.dialogRepository
