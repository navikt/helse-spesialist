...
class SchemaBuilder(
    ...
    val mutations =
        listOf(
            ...
            VarselMutation(
                handler = VarselMutationHandler(varselRepository = varselRepository),
            ),
            TildelingMutation(
                handler = TildelingMutationHandler(saksbehandlerhåndterer = saksbehandlerhåndterer),
            ),
            OpptegnelseMutation(
                handler = OpptegnelseMutationHandler(saksbehandlerhåndterer = saksbehandlerhåndterer),
            ),
            OverstyringMutation(
                handler = OverstyringMutationHandler(saksbehandlerhåndterer = saksbehandlerhåndterer),
            ),
            SkjonnsfastsettelseMutation(
                handler = SkjonnsfastsettelseMutationHandler(saksbehandlerhåndterer = saksbehandlerhåndterer),
            ),
