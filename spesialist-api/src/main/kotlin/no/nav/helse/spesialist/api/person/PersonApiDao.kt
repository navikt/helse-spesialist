...
class PersonApiDao(dataSource: DataSource) : HelseDao(dataSource) {
    fun finnEnhet(fødselsnummer: String) = requireNotNull(asSQL(
    ...
    fun finnInfotrygdutbetalinger(fødselsnummer: String) = asSQL(
    ...
    fun finnesPersonMedFødselsnummer(fødselsnummer: String) = asSQL(
    ...
    fun finnFødselsnummer(aktørId: Long): String? = asSQL(
    ...
    fun spesialistHarPersonKlarForVisningISpeil(fødselsnummer: String) = asSQL(
        """
