    ...
    fun finn(utbetalingId: UUID) =
        sessionOf(dataSource).use { session ->
            ...
            val statement = """
                ...
                WHERE ph.utbetaling_id = :utbetaling_id OR ph.generasjon_id = (SELECT unik_id FROM selve_vedtaksperiode_generasjon svg WHERE svg.utbetaling_id = :utbetaling_id)
        """
            session.run(
