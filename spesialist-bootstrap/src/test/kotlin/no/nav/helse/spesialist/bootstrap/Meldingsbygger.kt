...
import no.nav.helse.spesialist.bootstrap.context.Sykepengegrunnlagsfakta
                            ...
                            arbeidsgivere =
                                sykepengegrunnlagsfakta.arbeidsgivere.map {
                                    buildMap {
                                        ...
                                        put("omregnetÅrsinntekt", it.omregnetÅrsinntekt)
                                        put("inntektskilde", it.inntektskilde)
                                        if (it is Sykepengegrunnlagsfakta.SkjønnsfastsattArbeidsgiver) put("skjønnsfastsatt", it.skjønnsfastsatt)
                                    }
                                },
                        )
                    }
