...
internal abstract class AbstractDatabaseTest {
    ...
    protected fun opprettPerson(
        ...
        val sql =
            ...
            INSERT INTO varsel(unik_id, kode, vedtaksperiode_id, opprettet, behandling_ref)
            ...
            INSERT INTO totrinnsvurdering(id, saksbehandler, beslutter, person_ref, tilstand, opprettet, oppdatert)
            VALUES (${sequence_number}, '${saksbehandler_oid}', '${saksbehandler_oid}', ${sequence_number}, 'AVVENTER_SAKSBEHANDLER', now(), null);
    ...
    protected fun assertTabellinnhold(
        ...
        tabeller.removeAll(
            listOf(
                ...
                "venter_paa_kvittering_for_overstyring",
            ),
        )
