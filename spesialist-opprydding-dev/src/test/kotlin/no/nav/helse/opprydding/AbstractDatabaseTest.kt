...
internal abstract class AbstractDatabaseTest {
    ...
    protected fun opprettPerson(
        ...
        VALUES (${sequence_number}, now(), now(), 'AvventerSystem', ${sequence_number}, null, null, '${hendelse_id}', '${utbetaling_id}', true);
        ...
        INSERT INTO totrinnsvurdering(id, vedtaksperiode_id, er_retur, saksbehandler, beslutter, person_ref, utbetaling_id_ref, opprettet, oppdatert)
        VALUES (${sequence_number}, '${vedtaksperiode_id}', false, '${saksbehandler_oid}', '${saksbehandler_oid}', ${sequence_number}, ${sequence_number}, now(), null);
