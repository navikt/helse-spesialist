...
internal class VurderAutomatiskInnvilgelseTest {
    ...
    fun `publiserer godkjenningsmelding ved automatisert godkjenning`() =
        testMedSessionContext {
            ...
            Assertions.assertEquals(true, løsning.automatiskBehandling)
        }
    ...
    fun `Ferdigstiller kjede når perioden kan behandles automatisk`() =
        testMedSessionContext {
            ...
            context.utfør(commandContextDao, UUID.randomUUID(), command, it)
            Assertions.assertEquals("Ferdig", observatør.gjeldendeTilstand)
        }
