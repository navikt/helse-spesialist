...
class InMemoryRepositoriesAndDaos {
    ...
    private val commandContextDao = InMemoryCommandContextDao(meldingDao)
    ...
    private val oppgaveRepository = InMemoryOppgaveRepository(vedtaksperiodeRepository, påVentRepository, varselRepository)
    ...
    private val graderteAndreYtelserRepository = InMemoryGraderteAndreYtelserRepository()
    ...
    private val legacyPersonRepository =
        DelegatingLegacyPersonRepository(
            personRepository,
            vedtaksperiodeRepository,
    ...
    private val utbetalingDao = InMemoryUtbetalingDao()
    ...
    val sessionContext =
        InMemorySessionContext(
            ...
            graderteAndreYtelserRepository = graderteAndreYtelserRepository,
        )

    val sessionFactory = InMemorySessionFactory(sessionContext = sessionContext)
}
