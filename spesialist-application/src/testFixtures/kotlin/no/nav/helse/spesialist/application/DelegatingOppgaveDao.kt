...
class DelegatingOppgaveDao(
    ...
    override fun finnBehandledeOppgaver(
        ...
        val fødselsnummerForGodkjentTotrinnsvurdering =
                ...
                .filter { oppgave ->
                    ...
                    val fødselsnummer =
                        vedtaksperiodeRepository
                            .alle()
                            .find { it.id.value == oppgave.vedtaksperiodeId }
                            ?.identitetsnummer
                            ?.value
