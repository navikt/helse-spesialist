...
internal class OppgaveMediatorTest() {
    ...
    fun `lagrer oppgaver`() {
        ...
        verify(exactly = 1) { oppgaveDao.insertOppgave(HENDELSE_ID, COMMAND_CONTEXT_ID, OPPGAVENAVN1, any(), any(), any(), VEDTAKREF) }
        verify(exactly = 1) { oppgaveDao.insertOppgave(HENDELSE_ID, COMMAND_CONTEXT_ID, OPPGAVENAVN2, any(), any(), any(), VEDTAKREF) }
    ...
    fun `lagrer ikke dobbelt`() {
        ...
        verify(exactly = 1) { oppgaveDao.insertOppgave(HENDELSE_ID, COMMAND_CONTEXT_ID, OPPGAVENAVN1, any(), any(), any(), any()) }
