...
import no.nav.helse.spesialist.domain.overstyringer.OverstyrtTidslinjedag.Companion.byggSubsumsjoner
...
class OverstyrtTidslinje private constructor(
    ...
    fun byggSubsumsjoner(saksbehandlerEpost: String): List<Subsumsjon> =
